...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|YOU|PIKA|❤',
    sequenceColor: '#ff69b4', // Pink color
    gift: '', // No sticker/GIF
    pages: [
        { image: './image/Birthday!/cover.jpg', content: '' }, // Front cover
        { image: './image/Birthday!/photo1.jpg', content: 'Dear Pika, you bring so much joy and happiness! 💕' },
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        music: './music/Pika.mp3',
        countdown: 3,
        matrixText: 'HAPPYBIRTHDAY',
        matrixColor1: '#ff69b4', // Pink color
        matrixColor2: '#ff1493', // Pink color
        sequence: 'HAPPY|BIRTHDAY|TO|YOU|Pikaaaa|❤',
        sequenceColor: '#ff69b4', // Pink color
        gift: '', // No sticker/GIF
        enableBook: true,
        enableHeart: true,
        ...
        pages: [
            { image: './image/Birthday!/cover.jpg', content: '' }, // Front cover
            { image: './image/Birthday!/photo1.jpg', content: 'Dear Pika, you bring so much joy and happiness! 💕' },
            { image: './image/Birthday!/photo2.jpg', content: 'Senyummu menerangi setiap sudut ruang yang kaukunjungi! ✨' },
            { image: './image/Birthday!/photo3.jpg', content: 'You are such an amazing and beautiful person! 🌸' },
            { image: './image/Birthday!/photo4.jpg', content: 'Ketulusan dan kehangatanmu selalu mampu menyentuh jiwa! 💖' },
            { image: './image/Birthday!/photo5.jpg', content: 'Wishing you the most wonderful birthday ever! 🎉' },
            { image: './image/Birthday!/photo6.jpg', content: 'Semoga seluruh asamu lekas bermuara pada nyata! ⭐' },
            { image: './image/Birthday!/photo7.jpg', content: 'You deserve all the happiness! 💕' },
            { image: './image/Birthday!/photo8.jpg', content: 'Happy Birthdayy sayangg, happy 21th yaaa. Hari ini bukan cuma hari biasa, tapi hari ini adalah hari dimana dunia jadi lebih indah karena kamu lahir. Aku bersyukur banget bisa bareng sama kamu sampai detik ini. Selamat bertambah usia sayang. Semoga hal baik selalu beriringan dengan mu, semoga semesta selalu berpihak padamu, makasi ya udah nemenin aku walau aku kebanyakan tinggal tidur terus si tapi ya gitu aku emang ngantukan yaa, hehehee, oke aku bingung mau ngucapin apalagi, soalnya aku udah gabisa berkata kata jadi kamu doa apa aja ku aamiininn gitulah intinya, jujur aja aku ga expect bisa deket sama kamu karena aku kan awalnya ngechat kamu karena aku nanya nanya random ke kamu, eh malah kita bisa lanjut sampai hari ini dan detik ini ga expect banget si bisa ketemu perempuan lucu imut manis cantik dan gemes sama gembul juga heheeh, oke ya segitu duluu aja, sekali lagi happy birthdayy pikaa wish you all the best! ❤️🎂' },
            { image: './image/Birthday!/9.jpg', content: '' } // End cover
        ]
    };
